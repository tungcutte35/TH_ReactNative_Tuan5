...
const Order = ({ navigation, route }) => {
  ...
  const img = route.params?.img || imgPhone;
  const text =
    route.params?.text || "Điện Thoại Vsmart Joy 3 - Hàng chính hãng";
  const price = route.params?.price || "1.790.000 đ";
  return (
    <View style={styles.container}>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Details", { animation: "current" })}
      >
