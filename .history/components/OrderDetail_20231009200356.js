    ...
    <View style={styles.container}>
      ...
      <View style={styles.boxBottom}>
        ...
        <View style={styles.boxColor}>
          <Pressable style={styles.boxColor1}></Pressable>
          <Pressable style={styles.boxColor2}></Pressable>
          <Pressable style={styles.boxColor3}></Pressable>
          <Pressable style={styles.boxColor4}></Pressable>
        </View>
      </View>
    </View>
  );
