...
const OrderDetail = () => {
  ...
  const [provide, setProvide] = useState("đỏ");

  const handlerSetImgStatus = () => {
    setImg(imgBlueNavi);
    setTextColor("trắng");
  };
  return (
...
const styles = StyleSheet.create({
  ...
  boxColor1: { backgroundColor: "rgba(197, 241, 251, 1)" },
